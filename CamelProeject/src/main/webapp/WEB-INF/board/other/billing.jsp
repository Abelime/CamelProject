            ...
            <div class="card-body pt-4 p-3">
              <ul class="list-group">
                <li class="list-group-item border-0 d-flex p-4 mb-2 bg-gray-100 border-radius-lg">
                  <div class="d-flex flex-column">
                    <h6 class="mb-3 text-sm">인텔 코어i7-11세대 11700K (로켓레이크S)</h6>
                    <span class="mb-2 text-xs">소켓: <span class="text-dark font-weight-bold ms-2">인텔(소켓1200) </span></span>
                    <span class="mb-2 text-xs">제조공정: <span class="text-dark ms-2 font-weight-bold"> 14nm </span></span>
                     <span class="mb-2 text-xs">코어: : <span class="text-dark ms-2 font-weight-bold"> 8코어 </span></span>
                      <span class="mb-2 text-xs">쓰레드: <span class="text-dark ms-2 font-weight-bold"> 16쓰레드 </span></span>
                  </div>
                  <div class="ms-auto">
