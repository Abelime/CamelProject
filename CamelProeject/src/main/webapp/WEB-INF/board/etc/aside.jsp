...
<body>
    ...
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="${root}/main">
        <img src="${root}/img/main.png" class="navbar-brand-img h-100" alt="...">
      </a>
    </div>
      ...
      <ul class="navbar-nav">
    	...
    	<a class="nav-link" href="${root}/main">
         ...
         <li class="nav-item mt-3">
          <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Board Pages</h6>
        </li>
        ...
        <li class="nav-item mt-3">
          <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Information Pages</h6>
        </li>
          <c:forEach var="il" items="${InfoList}">
           <li class="nav-item">
           <c:if test="${il.infoname=='CPU'}">
             	<a class="nav-link" href="${root}/cpu/list">
           </c:if>
        	<c:if test="${il.infoname=='GPU'}">
             	<a class="nav-link" href="${root}/gpu/list">
           </c:if>
  				<div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>office</title>
         ...
         <li class="nav-item mt-3">
          <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Compare Pages</h6>
        </li>
           <li class="nav-item">
           <a class="nav-link" href="${root}/cpu/compare">
             <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>office</title>
                <g id="Basic-Elements" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        	...
        	<li class="nav-item">
           <a class="nav-link" href="${root}/gpu/compare">
             <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>office</title>
                <g id="Basic-Elements" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
